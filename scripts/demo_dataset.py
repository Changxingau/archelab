"""Run a single demo MAS episode and export it as dataset samples.

This script provides a quick, self-contained way to generate a tiny dataset
from the Kiro demo flow for manual inspection or README snippets.
"""
...
def main() -> None:
    """Run the demo episode and export JSONL and CSV summaries."""
